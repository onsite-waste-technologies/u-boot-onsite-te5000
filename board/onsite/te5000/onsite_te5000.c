...
/*
 * Copyright (C) 2020 Innovative Electronics, LLC
...
#define PIN_LED_RED AT91_PIO_PORTA, 10
#define PIN_LED_GRN AT91_PIO_PORTB, 0

static void board_leds_init(void)
{
	atmel_pio4_set_pio_output(PIN_LED_RED, 1);
